...
public  class UtilGen {
    ...
    public static   MethodSpec commandLine(){
     ...
     .beginControlFlow("if(!answer.equalsIgnoreCase(\"y\"))") 
       .addStatement("break")
     .endControlFlow()
     .addStatement("System.out.print(\"BlockInstance(Options: EquipmentInfo, HydaulicPumpBlock, TemperatureSensorBlock): \")")      
     .addStatement("BlockInstance = sc.nextLine()")
     .beginControlFlow("if(!BlockInstance.equals(\"EquipmentInfo\") && !BlockInstance.equals(\"HydaulicPumpBlock\") && !BlockInstance.equals(\"TemperatureSensorBlock\"))")
     ...
     .addStatement("break")
     .endControlFlow() 
     .beginControlFlow("if(BlockInstance.equals(\"HydaulicPumpBlock\") )")
